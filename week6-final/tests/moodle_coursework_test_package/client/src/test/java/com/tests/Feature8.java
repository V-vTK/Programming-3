...
public class Feature8 {
    ...
    void testSendCoordinates() throws IOException, KeyManagementException, KeyStoreException, CertificateException, NoSuchAlgorithmException, URISyntaxException {
        ...
        for(int i=0; i<selectedPlaces.length(); i++){
            ...
            for(int ii = 0; ii<placesForTour.length(); ii++){
                ...
                if(placesForTour.getJSONObject(ii).get("locationName").equals(selectedPlaces.getJSONObject(i).get("locationName"))){
                    selectedPlaces.getJSONObject(i).put("locationID", placesForTour.getJSONObject(ii).getInt("locationID"));
                    break;
                }
        ...
        oneTimeVisit.put("locationID", selectedPlaces.getJSONObject(0).getInt("locationID"));
        ...
        oneTimeVisit.clear();
        oneTimeVisit.put("locationID", selectedPlaces.getJSONObject(1).getInt("locationID"));
        oneTimeVisit.put("locationVisitor", "Seppo");
        timesToVisit = 7;
        ...
        oneTimeVisit.clear();
        oneTimeVisit.put("locationID", selectedPlaces.getJSONObject(2).getInt("locationID"));
        oneTimeVisit.put("locationVisitor", "Seppo");
        timesToVisit = 5;
        ...
        oneTimeVisit.clear();
        oneTimeVisit.put("locationID", selectedPlaces.getJSONObject(3).getInt("locationID"));
        oneTimeVisit.put("locationVisitor", "Seppo");
        timesToVisit = 4;
        ...
        oneTimeVisit.clear();
        oneTimeVisit.put("locationID", selectedPlaces.getJSONObject(4).getInt("locationID"));
        oneTimeVisit.put("locationVisitor", "Seppo");
        timesToVisit = 2;
